window.CV_DATA = {
    ...
    experience: [
        {
            ...
            projects: [
                ...
                },
                {
                    ...
                    tags: ["Unreal Engine", "Blueprint", "VR / XR", "3D"]
                },
                {
                    ...
                    tags: ["Unreal Engine", "Blueprint", "VR / XR"]
                },
                {
        ...
        },
        {
            ...
            description: "Visual Engineering was an even smaller team, with similar structure as Nagelld. I was the lead developer / programmer on the projects I worked on there. With 3 other team members, two of which were primarily doing modelling & scene setup. Here are some of the projects I worked on there:",
            logo: {
    ...
    /* ===== SECTIONS LAYOUT =====
     * Controls which sections appear in CV3 (and future designs) and in what order.
     * Add, remove, or reorder entries freely — the section numbers update automatically.
     *
     * icon:             strip icon key — 'summary' | 'experience' | 'education' | 'projects'
     * title:            section header label
     * type:             'summary' | 'fields'
     * dataKey:          key on CV_DATA that holds the section's items array (not needed for 'summary')
     * combineTitleOrg:  (optional) show "Title — Org" on one line instead of two (default: false)
     * ===== */
    sections: [
        {
            icon: 'summary',
